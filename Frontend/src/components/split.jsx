...
const Splitdialog = ({isopen,onclose,names,setSplit,setword1,setword2}) => {
  ...
  return (
   < dialog open={isopen} className='fixed inset-0 z-10 w-[100vw] h-[100vh] bg-black bg-opacity-50  '>
    <div className=' relative bg-white rounded-lg md:w-[30vw] w-[90vw] m-auto p-[2rem] mt-48 rounded-lg' >
     ...
     <div>
      {headform === 'form1' ? <Form1 names={names} setSplit={setSplit}  isopen={isopen} onclose={onclose}/> : <Form2 setSplit={setSplit} isopen={isopen} onclose={onclose} names={names} />}
      </div>
    </div>

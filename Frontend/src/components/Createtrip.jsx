    ...
    <>
      <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
        ...
        <div className="flex justify-between w-[240px] m-[10px]">
              <button type="button" className="bg-[#1a43bf] text-white px-4 py-1 rounded-md hover:bg-pink-700 duration-300" onClick={()=>autogenerate()} >
             Generate code
            </button>


            <CopyToClipboard text={tripCode}>
            <button type="button" className="bg-[#1a43bf] text-white px-4 py-1 rounded-md hover:bg-pink-700 duration-300">Copy</button>
      </CopyToClipboard>
